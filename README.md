...
- Public User Profiles & Activity History:
  - Tapping any user's profile avatar or display name in comments, post cards, or post details opens their public profile view.
  - Displays user header (avatar, display name, handle, bio) alongside their authored posts, written comments with quote previews, and liked posts.
...
3. Database Setup (Supabase):
   - Copy the contents of `supabase_schema.sql` into your Supabase project's SQL Editor and click Run.
